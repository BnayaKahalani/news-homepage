    ...
    <article>
      ...
      <div className="article__content">
        <p className="article__paragraph">
          We dive into the next evulution of the web that claims to put the power of the platforms back into the hands of the people. But is it really fulfilling its promise?
        </p>
